...
def calculate_F1(qi2lab_path: Path, merlin_path: Path, search_radius: float) -> dict:
...
if __name__ == "__main__":
    ...
    qi2lab_spots_path = root_path / Path(
        r"qi2labdatastore/segmentation/baysor/segmentation.csv"
    )
