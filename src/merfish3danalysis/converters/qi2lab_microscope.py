"""
Convert raw qi2lab widefield microscope data to qi2labdatastore.

convert a qi2lab experiment to the datastore object that the qi2lab 
"merfish3d-analysis" package uses. Most of the parameters are automatically 
extracted from the metadata written by qi2lab widefield microscopes.

Shepherd 2025/08 - refactor to converter file
...
def convert_data(
    ...
    # load baysor options
    # ------------------------
    if baysor_options_path is None:
        baysor_options_path = root_path / Path("baysor_options.toml")
