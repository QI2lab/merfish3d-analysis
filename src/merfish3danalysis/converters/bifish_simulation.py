...
for blue, yellow, red channels in a given round, then repeat for the next round.

Required user parameters for system dependent variables are at end of script.

Shepherd 2025/08 - refactor to converter
Shepherd 2025/07 - update script to new BiFISH package
...
def convert_statphysbio_simulation(
    root_path: Path,
